// https://github.com/CoinSpace/CoinSpace/blob/fd5c229ce60b67bcf88a342209931efb1cf87b93/server/lib/esmresolver.js
// https://github.com/cdimascio/express-openapi-validator/issues/660
...
export default function resolver(handlersPath, route, apiDoc) {
  ...
  if (!handlersCache[cacheKey]) {
    ...
    if (oId && baseName && typeof handlersPath === 'string') {
      ...
      handlersCache[cacheKey] = import(`file://${modulePath}`);
    }
  }
